Write-Host "Building FreeShell with GCC..." -ForegroundColor Green
...
gcc build/o/main.o build/o/shell_core.o build/o/shell_prompt.o build/o/command_parser.o build/o/error_handler.o build/o/history.o build/o/builtins.o -o build/FreeShell.exe

# Check if build was successful
if ($?) {
    Write-Host "Build successful! Executable is in build/FreeShell.exe" -ForegroundColor Green
} else {
